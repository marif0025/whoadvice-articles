...
**Meta description:** Learn how to epilate underarms using your exact device instructions, controlled technique, and clear stop signs for bleeding or worsening irritation.  
**Evidence model:** Research-based guide using exact-model instructions, official manufacturer support, and authoritative medical guidance; WhoAdvice did not conduct hands-on testing  
...
This guide uses exact product instructions for technique and US medical sources for cuts and warning signs. Start with your own manual, use controlled pressure and movement, and stop if the skin is injured or the reaction is becoming worse.
...
Check the skin warnings and any situations requiring a doctor’s advice. Do not proceed if the instructions say not to use the device on your skin in its current condition. The head should also be clean, correctly fitted, and undamaged.

| Device branch | Confirm before use |
|---|---|
...
<!-- IMAGE BRIEF: Place the four-panel underarm-technique illustration here, immediately before the numbered steps. Use the approved prompt in publisher-handoff.md. The illustration supports the steps but does not replace them. -->

## How to epilate underarms step by step

### 1. Check the exact model, head, and cap

Confirm that the epilating head is intended for underarms and identify the required cap. Do not borrow instructions from a related model.

### 2. Check when the manual says not to use it

Read the warnings first. The current [Philips BRE708/BRE728 manufacturer manual (PDF)](https://www.documents.philips.com/assets/20251218/e0b425ee1d6c4683af1ab3b700f9d4d0.pdf), for example, excludes skin that is damaged, inflamed, irritated, healing, or affected by a skin condition. Follow your model’s wording and seek advice when required.

### 3. Inspect and clean the epilating head

Check that the head is intact, correctly attached, and clean. Stop using a visibly damaged or worn head. Do not try to compensate by pressing harder.

### 4. Match the hair length to the manual

Trim only when instructed. Philips specifies an optimal 3–4 mm for BRE708/00 and BRE728/00. Do not apply that range to another epilator automatically.

### 5. Choose wet or dry use correctly

BRE708/00 and BRE728/00 permit completely wet or completely dry use. Philips says dry use may catch hair more effectively, but that is manufacturer guidance. BRE227/00 is corded, so keep it out of wet-use settings unless its exact current instructions explicitly permit them.

### 6. Prepare only as directed

Follow the manual rather than adding powder, oil, acids, antiseptic, ice, or numbing products. These were not established as a universal preparation routine.

### 7. Raise your arm and stretch the skin

Lift the arm and use your free hand to keep loose skin taut without pulling painfully. Stretching the skin may improve control, but it does not guarantee comfort or prevent injury.

### 8. Use the specified angle and cap

For BRE708/00 and BRE728/00, use 75 degrees without ProGuide or keep ProGuide flat. Official [BRE227/00 attachment guidance](https://www.usa.philips.com/c-f/XC000020632/how-do-i-use-the-attachments-of-my-philips-epilator) identifies its delicate-area cap, but not an exact angle.

### 9. Move slowly with light pressure

Use gentle contact and move slowly against visible growth where instructed. Hair direction can change, so reposition rather than repeatedly passing one spot. Stop for pinching, a cut, bleeding, or unusual, severe, or worsening pain.
...
Switch off or unplug before cleaning. Follow the water symbols for the head, attachments, and handle separately. Different water ratings do not share one rinse routine.

### 11. Finish and assess the skin

Finish according to the manual and assess the skin before applying anything. Use wound care instead of cosmetic aftercare for a cut or bleeding.

## What to do immediately after epilation

Keep device cleaning, routine skin care, and wound care separate. Switch off or unplug the epilator and clean only the parts its instructions permit you to rinse or brush.
...
Seek prompt medical advice for worsening pain, increasing redness or swelling, warmth, pus-like drainage, fever, chills, or feeling unwell. Seek urgent medical help for severe bleeding, bleeding that does not stop with firm direct pressure, or a severe or rapidly worsening reaction.

Plucking-type hair removal can also contribute to ingrown hairs. Do not scratch, pick, or squeeze a bump. The [NHS ingrown-hair guidance](https://www.nhs.uk/conditions/ingrown-hairs/) recommends seeking care when an area becomes very painful, hot, or swollen, or when fever, chills, or feeling unwell occur. These signs guide the next action; they do not establish a diagnosis from an article or photograph.

For recurrent irritation or ingrown hairs, stop epilating and seek qualified advice, especially when a skin condition makes the warnings unclear.
...
Stop epilating if the skin bleeds. Apply firm direct pressure and follow the cut-care steps above; seek urgent medical help if bleeding is severe or does not stop. Do not continue automatically on the other underarm.
...
Increasing warmth, swelling, drainage, fever, chills, or feeling unwell also warrants prompt medical advice.
...
Check the exact manufacturer guidance and assess the skin before applying deodorant. Philips support applying to BRE227/00 permits alcohol-free deodorant, but no universal waiting period was established. Follow the aftercare section above, and do not apply cosmetics to cut or bleeding skin.
